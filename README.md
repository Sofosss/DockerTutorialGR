...
περιβάλλον, εξαλείφοντας με αυτόν τον τρόπο πιθανά προβλήματα ασυμβατότητας συστημάτων. Είναι, δηλαδή, 
σχεδιασμένα με τρόπο τέτοιο έτσι ώστε να μπορούν να αναπτυχθούν/εκτελεστούν σε έναν (οποιοδήποτε)προσωπικό υπολογιστή, σε έναν cluster στο Cloud, σε έναν virtual server και γενικότερα σε οποιοδήποτε άλλο υπολογιστικό σύστημα.
