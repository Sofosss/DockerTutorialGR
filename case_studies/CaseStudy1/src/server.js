...
const port = process.env.NODE_PORT || 8891; // Set the server port from environment variables or use the default (8891)
const directory = process.env.VOLUME_DIR || "/opt/data_per"; // Set the directory for data storage from environment variables or use the default
